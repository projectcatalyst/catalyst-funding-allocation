...
* ****[**Broad categorisation advantages**](../../analysis/broad-vs-specific-categorisation.md) - Using just broad categories would mean getting all the benefits that are outlined in the analysis of the implications of using broad categorisation. Those include:
  * **Open funding**&#x20;
...
* [**Broad categorisation disadvantages**](../../analysis/broad-vs-specific-categorisation.md) - Using just broad categories would mean getting all the disadvantages that are outlined in the analysis of the implications of broad categorisation. Those disadvantages include:
...
* ****[**Some broad categorisation advantages**](../../analysis/broad-vs-specific-categorisation.md) - Having a mixture of these categorisation approaches gives some reduced benefits from those outlined.
...
* **Removes**[ **broad categorisation advantages**](../../analysis/broad-vs-specific-categorisation.md) - The advantages from using broad categories are reduced or removed by using a mix of broad categories and challenge settings. Those advantages that get reduced or removed include:&#x20;
