...
Many of the challenge settings from [previous selected challenges](../background/previous-selected-challenges/) and proposals that would go into the [categories](categories.md) funding structures would benefit from having access to rapid funding.
